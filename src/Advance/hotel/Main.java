...
public class Main {
    public static void main(String[] args) {
        ...
        //Print OOP.Inheritance.OOP.InheritanceAndAbstraction.person
        System.out.println(person);
        //Person Mark: 11111, Age: 41, Hometown: Sofia

        //Add OOP.Inheritance.OOP.InheritanceAndAbstraction.person
        hotel.add(person);
        ...
        // Get OOP.Inheritance.OOP.InheritanceAndAbstraction.person
